...
const exerciseSeeds: ExerciseSeed[] = [
  ...
  seed('Inverted Row', 'Bodyweight', 'Back', 'Upper Back', ['Lats', 'Biceps'], 'Horizontal Pull', 'Compound', 'Beginner'),
  seed('Pike Push Up', 'Bodyweight', 'Shoulders', 'Shoulders', ['Triceps', 'Upper Chest'], 'Vertical Push', 'Compound', 'Beginner'),
  seed('Bird Dog', 'Bodyweight', 'Core', 'Core', ['Glutes', 'Lower Back'], 'Anti-Extension', 'Isolation', 'Beginner'),
